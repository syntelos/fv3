    ...
    extends fv3.model.Model
{
        ...
        extends fv3.model.Object
    {
        ...
        public Pair(Pair previous, Face a, Face b){
            ...
            this.faceB = b;
            {
                final double a_a_x = (a.a.x+0.01);
                final double a_a_y = (a.a.y+0.01);
                final double a_a_z = (a.a.z+0.01);
                final double a_b_x = (a.b.x+0.01);
                final double a_b_y = (a.b.y+0.01);
                final double a_b_z = (a.b.z+0.01);
                final double a_c_x = (a.c.x+0.01);
                final double a_c_y = (a.c.y+0.01);
                final double a_c_z = (a.c.z+0.01);

                final double b_a_x = (b.a.x+0.01);
                final double b_a_y = (b.a.y+0.01);
                final double b_a_z = (b.a.z+0.01);
                final double b_b_x = (b.b.x+0.01);
                final double b_b_y = (b.b.y+0.01);
                final double b_b_z = (b.b.z+0.01);
                final double b_c_x = (b.c.x+0.01);
                final double b_c_y = (b.c.y+0.01);
                final double b_c_z = (b.c.z+0.01);
        ...
        public void define(GL2 gl){
            this.points.define(gl);
            this.lines.define(gl);
        }
    } 
    ...
    public Illustrator(Solid a, Solid b){
        super();
        super.add(new Material(GL2.GL_FRONT, GL2.GL_AMBIENT_AND_DIFFUSE, Color.Red));
        super.add(new ShadeModel(GL2.GL_FLAT));
        super.add(new PolygonMode.Line(GL2.GL_FRONT_AND_BACK));
        super.add(new Enable(GL2.GL_DEPTH_TEST));
        super.add(new PointSize(3.0));
