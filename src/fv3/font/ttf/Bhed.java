...
{
    public final static int ID = ('b'<<24)|('h'<<16)|('e'<<8)|('d');
    public final static int TYPE = 5;
    public final static String NAME = "bhed";
    public final static String DESC = "bitmap font header table";


    protected Bhed(int ofs, int len) {
        super(ofs,len);
    }
