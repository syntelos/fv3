...
{
    public final static int ID = ('g'<<24)|('a'<<16)|('s'<<8)|('p');
    public final static int TYPE = 24;
    public final static String NAME = "gasp";
    public final static String DESC = "grid-fitting and scan-conversion procedure table";


    protected Gasp(int ofs, int len) {
        super(ofs,len);
    }
