...
{
    public final static int ID = ('D'<<24)|('S'<<16)|('I'<<8)|('G');
    public final static int TYPE = 13;
    public final static String NAME = "DSIG";
    public final static String DESC = "digital signature table";


    protected Dsig(int ofs, int len) {
        super(ofs,len);
    }
