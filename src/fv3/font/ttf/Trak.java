...
{
    public final static int ID = ('t'<<24)|('r'<<16)|('a'<<8)|('k');
    public final static int TYPE = 61;
    public final static String NAME = "trak";
    public final static String DESC = "tracking table";


    protected Trak(int ofs, int len) {
        super(ofs,len);
    }
