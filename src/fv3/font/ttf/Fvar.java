 ...
 */
public final class Fvar
    extends Table
    implements Cloneable
{
    public final static int ID = ('f'<<24)|('v'<<16)|('a'<<8)|('r');
    public final static int TYPE = 23;
    public final static String NAME = "fvar";
    public final static String DESC = "font variation table";


    protected Fvar(int ofs, int len) {
        super(ofs,len);
    }
