...
{
    public final static int ID = ('c'<<24)|('v'<<16)|('a'<<8)|('r');
    public final static int TYPE = 11;
    public final static String NAME = "cvar";
    public final static String DESC = "CVT variation table";


    protected Cvar(int ofs, int len) {
        super(ofs,len);
    }
