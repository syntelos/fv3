...
{
    public final static int ID = ('k'<<24)|('e'<<16)|('r'<<8)|('n');
    public final static int TYPE = 39;
    public final static String NAME = "kern";
    public final static String DESC = "kerning table";


    protected Kern(int ofs, int len) {
        super(ofs,len);
    }
