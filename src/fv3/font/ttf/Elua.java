 ...
 */
public final class Elua
    extends Table
    implements Cloneable
{
    public final static int ID = ('E'<<24)|('L'<<16)|('U'<<8)|('A');
    public final static int TYPE = 17;
    public final static String NAME = "ELUA";
    public final static String DESC = "electronic end user license table";


    protected Elua(int ofs, int len) {
        super(ofs,len);
    }
