...
{
    public final static int ID = ('G'<<24)|('P'<<16)|('O'<<8)|('S');
    public final static int TYPE = 29;
    public final static String NAME = "GPOS";
    public final static String DESC = "glyph positioning table";


    protected Gpos(int ofs, int len) {
        super(ofs,len);
    }
