...
{
    public final static int ID = ('L'<<24)|('T'<<16)|('S'<<8)|('H');
    public final static int TYPE = 42;
    public final static String NAME = "LTSH";
    public final static String DESC = "linear threshold table";


    protected Ltsh(int ofs, int len) {
        super(ofs,len);
    }
