...
/**
 * bitmap location table AAT version
 * 
...
{
    public final static int ID = ('b'<<24)|('l'<<16)|('o'<<8)|('c');
    public final static int TYPE = 6;
    public final static String NAME = "bloc";
    public final static String DESC = "bitmap location table AAT version";


    protected Bloc(int ofs, int len) {
        super(ofs,len);
    }
