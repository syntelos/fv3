 ...
 */
public final class Fpgm
    extends Table
    implements Cloneable
{
    public final static int ID = ('f'<<24)|('p'<<16)|('g'<<8)|('m');
    public final static int TYPE = 22;
    public final static String NAME = "fpgm";
    public final static String DESC = "font program table";


    protected Fpgm(int ofs, int len) {
        super(ofs,len);
    }
