...
{
    public final static int ID = ('v'<<24)|('m'<<16)|('t'<<8)|('x');
    public final static int TYPE = 65;
    public final static String NAME = "vmtx";
    public final static String DESC = "vertical metrics table";


    protected Vmtx(int ofs, int len) {
        super(ofs,len);
    }
