 ...
 */
public final class Hdmx
    extends Table
    implements Cloneable
{
    public final static int ID = ('h'<<24)|('d'<<16)|('m'<<8)|('x');
    public final static int TYPE = 32;
    public final static String NAME = "hdmx";
    public final static String DESC = "horizontal device metrics table";


    protected Hdmx(int ofs, int len) {
        super(ofs,len);
    }
