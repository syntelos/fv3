 ...
 */
public final class InstructionCubicBezier
    extends Instruction
{


    InstructionCubicBezier() {
        super(CUBIC_BEZIER, "CubicBezier");
    }
    ...
    public void execute(InstructionStream is) {
        ...
        fept2.setY(in2y);
        CFFPoint fept3 = point_list.add(is);
        ...
        is.getFep().add(new CurveBezierCubic(GetCurrentPoint(), fept1, fept2, fept3));
