...
{
    public final static int ID = ('v'<<24)|('h'<<16)|('e'<<8)|('a');
    public final static int TYPE = 64;
    public final static String NAME = "vhea";
    public final static String DESC = "vertical header table";


    protected Vhea(int ofs, int len) {
        super(ofs,len);
    }
