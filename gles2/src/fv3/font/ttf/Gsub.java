...
{
    public final static int ID = ('G'<<24)|('S'<<16)|('U'<<8)|('B');
    public final static int TYPE = 31;
    public final static String NAME = "GSUB";
    public final static String DESC = "glyph substitution table";


    protected Gsub(int ofs, int len) {
        super(ofs,len);
    }
