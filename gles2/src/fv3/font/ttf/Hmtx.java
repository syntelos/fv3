...
{
    public final static int ID = ('h'<<24)|('m'<<16)|('t'<<8)|('x');
    public final static int TYPE = 35;
    public final static String NAME = "hmtx";
    public final static String DESC = "horizontal metrics table";


    protected Hmtx(int ofs, int len) {
        super(ofs,len);
    }
