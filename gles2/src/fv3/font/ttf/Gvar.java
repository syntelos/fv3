...
{
    public final static int ID = ('g'<<24)|('v'<<16)|('a'<<8)|('r');
    public final static int TYPE = 30;
    public final static String NAME = "gvar";
    public final static String DESC = "glyph variation table";


    protected Gvar(int ofs, int len) {
        super(ofs,len);
    }
