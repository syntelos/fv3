...
{
    public final static int ID = ('p'<<24)|('r'<<16)|('e'<<8)|('p');
    public final static int TYPE = 55;
    public final static String NAME = "prep";
    public final static String DESC = "control value program table";


    protected Prep(int ofs, int len) {
        super(ofs,len);
    }
