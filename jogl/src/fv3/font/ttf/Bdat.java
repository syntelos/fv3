...
{
    public final static int ID = ('b'<<24)|('d'<<16)|('a'<<8)|('t');
    public final static int TYPE = 3;
    public final static String NAME = "bdat";
    public final static String DESC = "bitmap data table AAT version";


    protected Bdat(int ofs, int len) {
        super(ofs,len);
    }
