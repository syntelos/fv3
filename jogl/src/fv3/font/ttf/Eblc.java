 ...
 */
public final class Eblc
    extends Table
    implements Cloneable
{
    public final static int ID = ('E'<<24)|('B'<<16)|('L'<<8)|('C');
    public final static int TYPE = 15;
    public final static String NAME = "EBLC";
    public final static String DESC = "bitmap location table OT version";


    protected Eblc(int ofs, int len) {
        super(ofs,len);
    }
