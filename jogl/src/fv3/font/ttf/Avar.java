...
{
    public final static int ID = ('a'<<24)|('v'<<16)|('a'<<8)|('r');
    public final static int TYPE = 1;
    public final static String NAME = "avar";
    public final static String DESC = "axis variation table";


    protected Avar(int ofs, int len) {
        super(ofs,len);
    }
