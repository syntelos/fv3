...
{
    public final static int ID = ('f'<<24)|('e'<<16)|('a'<<8)|('t');
    public final static int TYPE = 19;
    public final static String NAME = "feat";
    public final static String DESC = "layout feature table";


    protected Feat(int ofs, int len) {
        super(ofs,len);
    }
