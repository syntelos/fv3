...
{
    public final static int ID = ('f'<<24)|('m'<<16)|('t'<<8)|('x');
    public final static int TYPE = 21;
    public final static String NAME = "fmtx";
    public final static String DESC = "font metrics table";


    protected Fmtx(int ofs, int len) {
        super(ofs,len);
    }
