...
{
    public final static int ID = ('V'<<24)|('O'<<16)|('R'<<8)|('G');
    public final static int TYPE = 66;
    public final static String NAME = "VORG";
    public final static String DESC = "vertical origin table";


    protected Vorg(int ofs, int len) {
        super(ofs,len);
    }
