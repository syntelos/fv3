...
{
    public final static int ID = ('p'<<24)|('o'<<16)|('s'<<8)|('t');
    public final static int TYPE = 54;
    public final static String NAME = "post";
    public final static String DESC = "glyph name and PostScript compatibility table";


    protected Post(int ofs, int len) {
        super(ofs,len);
    }
