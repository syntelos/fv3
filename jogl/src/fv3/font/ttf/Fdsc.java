 ...
 */
public final class Fdsc
    extends Table
    implements Cloneable
{
    public final static int ID = ('f'<<24)|('d'<<16)|('s'<<8)|('c');
    public final static int TYPE = 18;
    public final static String NAME = "fdsc";
    public final static String DESC = "font descriptor table";


    protected Fdsc(int ofs, int len) {
        super(ofs,len);
    }
