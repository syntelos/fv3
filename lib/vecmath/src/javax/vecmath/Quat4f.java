 ...
 *
 * Modified by John Pritchard for Fv3 following Jan Eric Kyprianidis.
 *
 */
public class Quat4f extends Tuple4f implements java.io.Serializable {
    ...
    public Quat4f(AxisAngle4f a){
        super();
        /*
         * From lib3ds/matrix, Jan Eric Kyprianidis
         * (jdp)
         */
    ...
    public final Quat4f rotate(Quat4f q){
        return this.mul(q);
    }
    public final Quat4f rotate(AxisAngle4f a){
        return this.rotate(new Quat4f(a));
    }
    public final Quat4f rotX(double rx){

        double omega = -0.5 * rx;
        float X = (float)Math.sin(omega);
        Quat4f R = new Quat4f( X, 0f, 0f, (float)Math.cos(omega));
        return this.mul(R);
    }
    public final Quat4f rotY(double ry){

        double omega = -0.5 * ry;
        float Y = (float)Math.sin(omega);
        Quat4f R = new Quat4f( 0f, Y, 0f, (float)Math.cos(omega));
        return this.mul(R);
    }
    public final Quat4f rotZ(double rz){

        double omega = -0.5 * rz;
        float Z = (float)Math.sin(omega);
        Quat4f R = new Quat4f( 0f, 0f, Z, (float)Math.cos(omega));
        return this.mul(R);
    }
    public final Quat4f rotXY(double rx, double ry){

        double omega = -0.5 * rx;
        double s = Math.sin(omega);
        float X = (float)(s * rx);
        float Y = (float)(s * ry);
        Quat4f R = new Quat4f( X, Y, 0f, (float)Math.cos(omega));
        return this.mul(R);
    }
    /**
     ...
     */
    public final Quat4f set(Matrix4d m1)
    {
     ...
     */
    public final Quat4f set(Matrix3d m1)
    {
     ...
     * @param a  the AxisAngle to be emulated
     */
    public final Quat4f set(AxisAngle4d a)
    {
        float mag,amag;
        // Quat = cos(theta/2) + sin(theta/2)(roation_axis) 
